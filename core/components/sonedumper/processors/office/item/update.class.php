...
class sOneDumperOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('sonedumper_item_err_ns');
        }
...
return 'sOneDumperOfficeItemUpdateProcessor';
